...
export function RecentTransfersTable({ transfers, isLoading }: RecentTransfersTableProps) {
              ...
              {isLoading ? (
                ...
                transfers.map((transfer) => (
                  <TableRow key={transfer.id}>
                    ...
                    <TableCell className="font-mono text-xs">{transfer.destination}</TableCell>
