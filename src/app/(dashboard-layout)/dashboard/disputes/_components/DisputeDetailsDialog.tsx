        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <p className="text-sm font-medium mb-3">Raised By</p>
                <div className="bg-muted/50 p-4 rounded-lg space-y-2">
                  <div className="flex items-center gap-3">
                    {dispute.user?.picture ? (
                      <img
                        src={dispute.user.picture}
              ...
              <div>
                <p className="text-sm font-medium mb-3">Against</p>
                <div className="bg-muted/50 p-4 rounded-lg space-y-2">
                  <div className="flex items-center gap-3">
                    {dispute.against?.picture ? (
                      <img
                        src={dispute.against.picture}
              ...
              <>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {dispute.pictures.map((picture: string, idx: number) => (
