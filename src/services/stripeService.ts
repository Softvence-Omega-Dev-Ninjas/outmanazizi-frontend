...
export const stripeService = {
  ...
  processRefund: async (data: { orderId: string; amount: string }, token: string): Promise<any> => {
    return api.post('/payments/refund', data, token)
  },

  createTransfer: async (data: { orderId: string; amountCents: number }, token: string): Promise<any> => {
